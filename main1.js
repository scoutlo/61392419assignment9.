...
{
    const reply = await fetch("https://jsonplaceholder.typicode.com/post");
...
{
    const reply1 = await fetch ("https://jsonplaceholder.typicode.com/users")
    return await reply1.json();
}
...
{
    let arr = [];
    const reply2 = await fetch ("https://jsonplaceholder.typicode.com/comments");
    const data = awiat reply2.json();
...
{
    const reply = await fetch("https://jsonplaceholder.typicode.com/" + userID);
...
{
    let arr = [];
    const reply = await fetch("https://jsonplaceholder.typicode.com/todos?userid=$(userID)")
    const a = await reply.json()
